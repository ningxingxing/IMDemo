...
public class ChatActivity extends FragmentActivity{
    ...
    private void initListener() {
        ...
        easeChatFragment.setChatFragmentListener(new EaseChatFragment.EaseChatFragmentHelper() {
            ...
            public void onEnterToChatDetails() {
                Intent intent = new Intent(getApplication(),GroupDetailActivity.class);
        ...
        if (mChatType == EaseConstant.CHATTYPE_GROUP){
            ...
            localBroadcastManager.registerReceiver(ExitGroupReceiver,new IntentFilter(Constant.EXIT_GROUP));
        }
    }
    ...
    private void initData() {
        ...
        easeChatFragment.setArguments(getIntent().getExtras());//传递参数给EaseChatFragment
