...
public class LoginActivity extends AppCompatActivity {
    ...
    @BindView(R.id.ec_edit_username)
    EditText ecEditUsername;
    @BindView(R.id.ec_edit_password)
    EditText ecEditPassword;
    @BindView(R.id.ec_btn_sign_up)
    Button ecBtnSignUp;
    @BindView(R.id.ec_btn_sign_in)
    Button ecBtnSignIn;
    ...
    @OnClick({R.id.ec_btn_sign_up, R.id.ec_btn_sign_in})
    public void onClick(View view) {
        switch (view.getId()) {

            case R.id.ec_btn_sign_up://注册
                signUp();
                break;
            case R.id.ec_btn_sign_in://登录
                signIn();
    ...
    private void signIn() {
        ...
        mDialog.show();
        final String username = ecEditUsername.getText().toString().trim();
        final String password = ecEditPassword.getText().toString().trim();
